...
function MetricCard({ label, value, delay = 0, active }: {
    ...
    return (
        <section className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 items-center py-16 lg:py-24">
            ...
            <div ref={stackRef} className="grid gap-4">
                <MetricCard label="Sessions this month" value={<Counter to={24} active={inView} />} delay={0.00} active={inView} />
                <MetricCard label="Total volume" value={<Counter to={32} suffix="k" active={inView} />} delay={0.08} active={inView} />
                <MetricCard label="Top PR (lb)" value={<Counter to={405} active={inView} />} delay={0.16} active={inView} />
            </div>
        </section>
    )
}
